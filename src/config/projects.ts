...
export const projectData: Record<string, Category> = {
  'counter-strike': {
    ...
    projects: [
      { id: 'floats-v1', link: '/counter-strike/floats-v1', placeholderText: 'Floats V1', title: 'Floats-V1', description: 'Calculator V1', tags: ['Calculator', 'Ported'], wip: true, color: shuffledColors[1], 'original-reference': 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/floatsV1' },
      { id: 'floats-v2', link: '/counter-strike/floats-v2', placeholderText: 'Floats V2', title: 'Floats-V2', description: 'Calculator V2', tags: ['Calculator', 'Ported'], wip: true, color: shuffledColors[1], 'original-reference': 'https://github.com/andersonproescholdbell/floats' },
      { id: 'floats-v3', link: '/counter-strike/floats-v3', placeholderText: 'Floats V3', title: 'Floats-V3', description: 'Calculator V3', tags: ['Calculator', 'Ported'], wip: true, color: shuffledColors[1], 'original-reference': 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/floatsV3' },
      { id: 'items-assistant', link: 'https://github.com/andersonproescholdbell/csgo-items-assistant', placeholderText: 'Assistant', title: 'Items Assistant', description: 'Tool for managing CS items.', tags: ['Tool', 'External'], color: shuffledColors[2] },
      { id: 'market-floats', link: 'https://github.com/andersonproescholdbell/market-float-searcher-csgo', placeholderText: 'Market Floats', title: 'Market Float Searcher', description: 'Find low-float items on the market.', tags: ['Tool', 'External'], color: shuffledColors[3] },
      { id: 'market-bluegems', link: 'https://github.com/andersonproescholdbell/bluegem-finder', placeholderText: 'Market Gems', title: 'Market Bluegem Finder', description: 'Find case-hardened blue gems.', tags: ['Tool', 'External'], color: shuffledColors[4] },
    ],
  },
  games: {
    title: 'Games',
    ...
    projects: [
      { id: 'catan-board-generator', link: '/games/catan-board-generator', placeholderText: 'Catan', title: 'Catan Board Generator', description: 'A Catan board generator that goes a bit further.', tags: ['Algorithm', 'SVG', 'Ported'], color: shuffledColors[8], 'original-reference': 'https://github.com/andersonproescholdbell/Advantageo-Catan-Alternative-Client-Setup' },
      { id: 'wordle', link: '/games/wordle', placeholderText: 'Wordle', title: 'Wordle', description: 'A simple version.', tags: ['Game Logic', 'Ported'], color: shuffledColors[9], 'original-reference': 'https://github.com/andersonproescholdbell/wordle' },
      { id: 'AKordle', link: '/games/akordle', placeholderText: 'AKordle', title: 'AKordle', description: 'An enhanced version.', tags: ['Game Logic', 'CSS', 'Ported'], color: shuffledColors[9], 'original-reference': 'https://github.com/andersonproescholdbell/AKordle/tree/main' },
      { id: 'circles-v1', link: '/games/circles-v1', placeholderText: 'Circles', title: 'Circles V1', description: 'Similar to Agario.', tags: ['Game Logic', 'Ported'], color: shuffledColors[11], 'original-reference': 'https://github.com/andersonproescholdbell/akpcircles' },
      { id: 'circles-v2', link: '/games/circles-v2', placeholderText: 'Circles', title: 'Circles V2', description: 'An incomplete project that showcased camera following.', tags: ['Phaser.js', 'Canvas', 'Ported'], color: shuffledColors[11], 'original-reference': 'https://github.com/andersonproescholdbell/newakpcircles'  },
      { id: 'ai-or-real-human', link: '/games/ai-or-real-human', placeholderText: 'AI or Real', title: 'AI or Real Human', description: 'Guess if the image is AI-generated or real human photo.', tags: ['AI', 'Game', 'Ported'], color: shuffledColors[13], 'original-reference': 'https://github.com/andersonproescholdbell/hackathon-project' },
      { id: 'takuzu-solver', link: 'https://github.com/andersonproescholdbell/takuzu-solver', placeholderText: 'Takuzu', title: 'Takuzu Solver', description: 'A takuzu solver.', tags: ['AI', 'Game', 'External'], color: shuffledColors[14] },
    ],
  },
  bots: {
    title: 'Bots',
  ...
  geometric: {
    ...
    projects: [
      ...
      { id: 'fractal-square-4', link: '/geometric/fractal-square-4', placeholderText: 'Square 4', title: 'Square Fractal 4', description: 'Rule: If previous two are same, cannot be neighbors.', tags: ['Fractal', 'Canvas', 'Ported'], color: shuffledColors[27], "original-reference": 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/geometric/square4' },
      { id: 'fractal-pentagon-1', link: '/geometric/fractal-pentagon-1', placeholderText: 'Pentagon 1', title: 'Pentagon Fractal 1', description: 'Rule: Not the same vertex twice.', tags: ['Fractal', 'Canvas', 'Ported'], color: shuffledColors[31], "original-reference": 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/geometric/pent1' },
      { id: 'fractal-pentagon-2', link: '/geometric/fractal-pentagon-2', placeholderText: 'Pentagon 2', title: 'Pentagon Fractal 2', description: 'Rule: If previous two are same, cannot be neighbors.', tags: ['Fractal', 'Canvas', 'Ported'], color: shuffledColors[31], "original-reference": 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/geometric/pent2' },
      { id: 'fractal-hexagon', link: '/geometric/fractal-hexagon', placeholderText: 'Hexagon', title: 'Hexagon Fractal 1', description: 'Rule: Not the same vertex twice.', tags: ['Fractal', 'Canvas', 'Ported'], color: shuffledColors[33], "original-reference": 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/geometric/hex1' },
    ],
  },
};