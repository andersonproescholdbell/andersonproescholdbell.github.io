...
export const projectData: Record<string, Category> = {
  'counter-strike': {
    ...
    projects: [
      { id: 'floats-v1', link: '/counter-strike/floats-v1', placeholderText: 'Floats V1', title: 'Floats-V1', description: 'Calculator V1', tags: ['Calculator', 'Ported'], wip: true, color: shuffledColors[1] },
      { id: 'floats-v2', link: '/counter-strike/floats-v2', placeholderText: 'Floats V2', title: 'Floats-V2', description: 'Calculator V2', tags: ['Calculator', 'Ported'], wip: true, color: shuffledColors[1] },
      { id: 'floats-v3', link: '/counter-strike/floats-v3', placeholderText: 'Floats V3', title: 'Floats-V3', description: 'Calculator V3', tags: ['Calculator', 'Ported'], wip: true, color: shuffledColors[1] },
  ...
  games: {
    ...
    projects: [
      ...
      { id: 'wordle', link: '/games/wordle', placeholderText: 'Wordle', title: 'Wordle', description: 'A simple version.', tags: ['Game Logic', 'Ported'], wip: false, color: shuffledColors[9] },
      ...
      { id: 'circles-v1', link: '/games/circles-v1', placeholderText: 'Circles', title: 'Circles V1', description: 'Similar to Agario.', tags: ['Game Logic', 'Ported'], wip: true, color: shuffledColors[11] },
      { id: 'circles-v2', link: '/games/circles-v2', placeholderText: 'Circles', title: 'Circles V2', description: 'An incomplete project that showcased camera following.', tags: ['Phaser.js', 'Canvas', 'Ported'], wip: false, color: shuffledColors[11] },
      ...
      { id: 'ai-or-real-human', link: '/games/ai-or-real-human', placeholderText: 'AI or Real', title: 'AI or Real Human', description: 'Guess if the image is AI-generated or real.', tags: ['AI', 'Game', 'Ported'], wip: true, color: shuffledColors[13] },
  ...
  computation: {
    ...
    projects: [
      { id: 'turing-interactive', link: '/computation/turing-machine-simulator-interactive', placeholderText: 'Turing', title: 'Turing Machine (Interactive)', description: 'An interactive Turing Machine simulator.', tags: ['Simulator', 'UI', 'Ported'], wip: true, color: shuffledColors[21] },
  ...
  geometric: {
    ...
    projects: [
      { id: 'fractal-triangle', link: '/geometric/fractal-triangle', placeholderText: 'Triangle', title: 'Sierpinski\'s Triangle', description: 'Standard chaos game rules.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[26] },
      { id: 'fractal-square-1', link: '/geometric/fractal-square-1', placeholderText: 'Square 1', title: 'Square Fractal 1', description: 'Rule: Not the same vertex twice.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[27] },
      { id: 'fractal-square-2', link: '/geometric/fractal-square-2', placeholderText: 'Square 2', title: 'Square Fractal 2', description: 'Rule: Not clockwise/counter-clockwise of previous.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[27] },
      { id: 'fractal-square-3', link: '/geometric/fractal-square-3', placeholderText: 'Square 3', title: 'Square Fractal 3', description: 'Rule: Not vertex 2 away from previous.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[27] },
      { id: 'fractal-square-4', link: '/geometric/fractal-square-4', placeholderText: 'Square 4', title: 'Square Fractal 4', description: 'Rule: If previous two are same, cannot be neighbors.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[27] },
      { id: 'fractal-pentagon-1', link: '/geometric/fractal-pentagon-1', placeholderText: 'Pentagon 1', title: 'Pentagon Fractal 1', description: 'Rule: Not the same vertex twice.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[31] },
      { id: 'fractal-pentagon-2', link: '/geometric/fractal-pentagon-2', placeholderText: 'Pentagon 2', title: 'Pentagon Fractal 2', description: 'Rule: If previous two are same, cannot be neighbors.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[31] },
      { id: 'fractal-hexagon', link: '/geometric/fractal-hexagon', placeholderText: 'Hexagon', title: 'Hexagon Fractal 1', description: 'Rule: Not the same vertex twice.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[33] },
    ],
  },
};