...
export const projectData: Record<string, Category> = {
  'counter-strike': {
    ...
    projects: [
      ...
      { id: 'floats-v2', link: '/counter-strike/floats-v2', placeholderText: 'Floats V2', title: 'Float Creator V2', description: 'Calculator V2: A second version of the tradeup calculator.', tags: ['Webpage', 'React', 'JavaScript', 'Ported'], wip: true, color: shuffledColors[1], 'original-reference': 'https://github.com/andersonproescholdbell/floats' },
