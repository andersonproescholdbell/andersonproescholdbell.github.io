...
export const projectData: Record<string, Category> = {
  'counter-strike': {
    ...
    projects: [
      { id: 'floatsv1', link: '/counter-strike/floatsv1', placeholderText: 'FloatsV1', title: 'FloatsV1', description: 'Calculator V1', tags: ['Calculator'], wip: true, color: shuffledColors[1] },
      { id: 'floatsv2', link: '/counter-strike/floatsv2', placeholderText: 'FloatsV2', title: 'FloatsV2', description: 'Calculator V2', tags: ['Calculator'], wip: true, color: shuffledColors[2] },
      { id: 'floatsv3', link: '/counter-strike/floatsv3', placeholderText: 'FloatsV3', title: 'FloatsV3', description: 'Calculator V3', tags: ['Calculator'], wip: true, color: shuffledColors[3] },
  ...
  games: {
    ...
    projects: [
      ...
      { id: 'wordle-enhanced', link: '/games/wordle-enhanced', placeholderText: 'Wordle', title: 'Wordle Enhanced', description: 'An enhanced version.', tags: ['Game Logic', 'CSS'], wip: false, color: shuffledColors[10] },
      ...
      { id: 'circles-enhanced', link: '/games/circles-enhanced', placeholderText: 'Circles', title: 'Circles Enhanced', description: 'More similar to Agario.', tags: ['Game Logic', 'Canvas'], wip: true, color: shuffledColors[12] },
  ...
  bots: {
    ...
    projects: [
      ...
      { id: 'discord-random', link: 'https://github.com/andersonproescholdbell/Impractical-Discord-Bot', placeholderText: 'Discord', title: 'Impractical Discord Bot', description: 'A bot with various random commands.', tags: ['Discord.js'], color: shuffledColors[16] },
  ...
  computation: {
    ...
    projects: [
      ...
      { id: 'turing-cli', link: 'https://github.com/andersonproescholdbell/Turing-Machine-Simulator', placeholderText: 'Turing', title: 'Turing Machine (CLI)', description: 'A command-line Turing Machine simulator.', tags: ['CLI', 'Java'], color: shuffledColors[22] },
      ...
      { id: 'nfsm-sim', link: 'https://github.com/andersonproescholdbell/Nondeterministic-Finite-State-Machine-Simulator', placeholderText: 'State Machine', title: 'NFSM Simulator', description: 'A non-deterministic finite state machine simulator.', tags: ['FSM', 'Java'], color: shuffledColors[24] },
    ],
  },
  geometric: {
    title: 'Geometric',
    ...
    projects: [
      ...
      { id: 'fractal-square-2', link: '/geometric/fractal-square-2', placeholderText: 'Square 2', title: 'Square Fractal 2', description: 'Rule: Not clockwise/counter-clockwise of previous.', tags: ['Fractal', 'Canvas'], wip: true, color: shuffledColors[28] },
      { id: 'fractal-square-3', link: '/geometric/fractal-square-3', placeholderText: 'Square 3', title: 'Square Fractal 3', description: 'Rule: Not vertex 2 away from previous.', tags: ['Fractal', 'Canvas'], wip: true, color: shuffledColors[29] },
      { id: 'fractal-square-4', link: '/geometric/fractal-square-4', placeholderText: 'Square 4', title: 'Square Fractal 4', description: 'Rule: If previous two are same, cannot be neighbors.', tags: ['Fractal', 'Canvas'], wip: true, color: shuffledColors[30] },
      ...
      { id: 'fractal-pentagon-2', link: '/geometric/fractal-pentagon-2', placeholderText: 'Pentagon 2', title: 'Pentagon Fractal 2', description: 'Rule: If previous two are same, cannot be neighbors.', tags: ['Fractal', 'Canvas'], wip: true, color: shuffledColors[32] },
