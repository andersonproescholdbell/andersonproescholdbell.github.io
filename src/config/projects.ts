...
export const projectData: Record<string, Category> = {
  'counter-strike': {
    ...
    projects: [
      { id: 'floats-v1', link: '/counter-strike/floats-v1', placeholderText: 'Floats V1', title: 'Floats-V1', description: 'Calculator V1', tags: ['Webpage', 'JavaScript', 'HTML', 'CSS', 'Ported'], wip: true, color: shuffledColors[1], 'original-reference': 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/floatsV1' },
      { id: 'floats-v2', link: '/counter-strike/floats-v2', placeholderText: 'Floats V2', title: 'Floats-V2', description: 'Calculator V2', tags: ['Webpage', 'React', 'JavaScript', 'Ported'], wip: true, color: shuffledColors[1], 'original-reference': 'https://github.com/andersonproescholdbell/floats' },
      { id: 'floats-v3', link: '/counter-strike/floats-v3', placeholderText: 'Floats V3', title: 'Floats-V3', description: 'Calculator V3', tags: ['Webpage', 'JavaScript', 'HTML', 'CSS', 'Ported'], wip: true, color: shuffledColors[1], 'original-reference': 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/floatsV3' },
