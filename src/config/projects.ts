...
export const projectData: Record<string, Category> = {
  ...
  games: {
    ...
    projects: [
      ...
      { id: 'ai-or-real-human', link: '/games/ai-or-real-human', placeholderText: 'AI or Real', title: 'AI or Real Human', description: 'Guess if the image is AI-generated or real.', tags: ['AI', 'Game', 'Ported'], wip: true, color: shuffledColors[13], 'original-reference': 'https://github.com/andersonproescholdbell/hackathon-project' },
