...
export const projectData: Record<string, Category> = {
  ...
  games: {
    ...
    projects: [
      { id: 'catan-board-generator', link: '/games/catan-board-generator', placeholderText: 'Catan', title: 'Catan Board Generator', description: 'A Catan board generator that goes a bit further.', tags: ['Algorithm', 'SVG', 'Ported'], wip: true, color: shuffledColors[8] },
      { id: 'wordle', link: '/games/wordle', placeholderText: 'Wordle', title: 'Wordle', description: 'A simple version.', tags: ['Game Logic', 'Ported'], wip: false, color: shuffledColors[9], 'original-reference': 'https://github.com/andersonproescholdbell/wordle' },
      { id: 'AKordle', link: '/games/akordle', placeholderText: 'AKordle', title: 'AKordle', description: 'An enhanced version.', tags: ['Game Logic', 'CSS', 'Ported'], wip: false, color: shuffledColors[9], 'original-reference': 'https://github.com/andersonproescholdbell/AKordle/tree/main' },
      { id: 'circles-v1', link: '/games/circles-v1', placeholderText: 'Circles', title: 'Circles V1', description: 'Similar to Agario.', tags: ['Game Logic', 'Ported'], wip: true, color: shuffledColors[11], 'original-reference': 'https://github.com/andersonproescholdbell/akpcircles' },
      { id: 'circles-v2', link: '/games/circles-v2', placeholderText: 'Circles', title: 'Circles V2', description: 'An incomplete project that showcased camera following.', tags: ['Phaser.js', 'Canvas', 'Ported'], wip: false, color: shuffledColors[11], 'original-reference': 'https://github.com/andersonproescholdbell/newakpcircles'  },
      { id: 'ai-or-real-human', link: '/games/ai-or-real-human', placeholderText: 'AI or Real', title: 'AI or Real Human', description: 'Guess if the image is AI-generated or real human photo.', tags: ['AI', 'Game', 'Ported'], wip: false, color: shuffledColors[13], 'original-reference': 'https://github.com/andersonproescholdbell/hackathon-project' },
  ...
  geometric: {
    ...
    projects: [
      ...
      { id: 'fractal-square-4', link: '/geometric/fractal-square-4', placeholderText: 'Square 4', title: 'Square Fractal 4', description: 'Rule: If previous two are same, cannot be neighbors.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[27], "original-reference": 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/geometric/square4' },
      { id: 'fractal-pentagon-1', link: '/geometric/fractal-pentagon-1', placeholderText: 'Pentagon 1', title: 'Pentagon Fractal 1', description: 'Rule: Not the same vertex twice.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[31], "original-reference": 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/geometric/pent1' },
      { id: 'fractal-pentagon-2', link: '/geometric/fractal-pentagon-2', placeholderText: 'Pentagon 2', title: 'Pentagon Fractal 2', description: 'Rule: If previous two are same, cannot be neighbors.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[31], "original-reference": 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/geometric/pent2' },
      { id: 'fractal-hexagon', link: '/geometric/fractal-hexagon', placeholderText: 'Hexagon', title: 'Hexagon Fractal 1', description: 'Rule: Not the same vertex twice.', tags: ['Fractal', 'Canvas', 'Ported'], wip: true, color: shuffledColors[33], "original-reference": 'https://github.com/andersonproescholdbell/andersonproescholdbell.github.io/tree/211aae76a56844745e8cb9a5b1e74379d9ab2b30/geometric/hex1' },
    ],
  },
};