// Core utility functions from floats-v2 - EXACT PORT - DO NOT MODIFY
...
// Removed getJSON function as it depends on CORS proxy which won't work client-side
// Price data functionality will be removed in port