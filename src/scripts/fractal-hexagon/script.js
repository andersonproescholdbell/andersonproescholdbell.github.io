  ...
  methods: {
    ...
    start: function() {
      ...
      var numberOfSides = 6,
        ...
        // Calculate hexagon bounds with rotation
        minX = Infinity, maxX = -Infinity, minY = Infinity, maxY = -Infinity;
      
      // Find the actual bounds of the rotated hexagon
      ...
      var hexagonWidth = maxX - minX;
      var hexagonHeight = maxY - minY;
      
      var unitCenterX = (minX + maxX) / 2;
      var unitCenterY = (minY + maxY) / 2;
      
      // Calculate maximum size that fits with 5% padding
      var maxSizeForWidth = (this.canw * 0.9) / hexagonWidth;
      var maxSizeForHeight = (this.canh * 0.9) / hexagonHeight;
